...
ARTICLE_JSON = "wired_science_articles.json"
HTML_DIR = "wired_rendered_html"
AUTH_STATE = "wired_login_state.json"
...
def save_login_state():
    with sync_playwright() as p:
        ...
        page.goto("https://www.wired.com/login/")
    ...
    with sync_playwright() as p:
        ...
        for idx, article in enumerate(articles, 1):
            try:
                ...
                page.goto(article["url"], wait_until="load", timeout=60000)
                time.sleep(3)  # extra time for paywall content to render
                html = page.content()

                file_path = os.path.join(HTML_DIR, f"wired_article_{idx:04d}.html")
